...
%% Define the color of all items. Including all types of bulllet points and buttons.
\newcommand{\setbeamercolorsall}[2]{%
  \setbeamercolor{structure}{#1=#2}%
  \setbeamercolor{frametitle}{#1=#2}%
  \setbeamercolor{author in head/foot}{#1=#2}%
  \setbeamercolor{title in head/foot}{#1=#2}%
  \setbeamercolor{date in head/foot}{#1=#2}%
  \setbeamercolor{page number in head/foot}{#1=#2}%
  \setbeamercolor{title}{#1=#2}%
\setbeamercolor{titlelike}{#1=#2}%
}

\setbeamercolorsall{fg}{Mahogany}
